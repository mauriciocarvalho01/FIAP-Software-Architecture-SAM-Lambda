...
```bash
client-authentication-lbda$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
client-authentication-lbda$ sam logs -n HelloWorldFunction --stack-name client-authentication-lbda --tail
```
...
```bash
client-authentication-lbda$ cd hello-world
